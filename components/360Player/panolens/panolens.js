...
const ImageLoader = {
    ...
    load: function (
        ...
        for (let iconName in DataImage) {
            if (
                DataImage.hasOwnProperty(iconName) &&
                url === DataImage[iconName]
            ) {
                reference = iconName;
            }
        }
...
Infospot.prototype = Object.assign(Object.create(Sprite.prototype), {
    ...
    translateElement: function (x, y) {
        ...
        delta =
            element.verticalDelta !== undefined ? element.verticalDelta : 40;
    ...
    hide: function (delay = 0) {
        const { animated, hideAnimation, showAnimation, material, element } =
            this;
    ...
    createMainMenu: function (menus) {
        ...
        for (var i = 0; i < menus.length; i++) {
            ...
            if (menus[i].subMenu && menus[i].subMenu.length > 0) {
                ...
                item.addSelection(title).addSubMenu(
                    menus[i].title,
                    menus[i].subMenu
                );
            }
...
VideoPanorama.prototype = Object.assign(Object.create(Panorama.prototype), {
     ...
     */
    load: function () {
        const { muted, loop, autoplay, playsinline, crossOrigin } =
            this.options;
...
function DeviceOrientationControls(camera, domElement) {
    ...
    this.update = function (ignoreUpdate) {
        ...
        var alpha = scope.deviceOrientation.alpha
            ? Math$1.degToRad(scope.deviceOrientation.alpha) +
...
function Viewer(options) {
    ...
    options.autoHideInfospot =
        options.autoHideInfospot !== undefined
            ? options.autoHideInfospot
            : true;
    ...
    onMouseUp: function (event) {
        ...
        const type =
            (this.userMouse.x >= event.clientX - this.options.clickTolerance &&
                this.userMouse.x <=
                    event.clientX + this.options.clickTolerance &&
                this.userMouse.y >=
                    event.clientY - this.options.clickTolerance &&
                this.userMouse.y <=
                    event.clientY + this.options.clickTolerance) ||
                ...
                if (this.hoverObject !== intersect_entity) {
                    ...
                    if (this.hoverObject.dispatchEvent) {
                        ...
                        if (
                            ...
                            this.reticle.start(
                                this.onTap.bind(this, event, 'click')
                            );
                        }
                    }
                }
