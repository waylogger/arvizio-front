...
function NewProject() {
    ...
    const [modalD3, setModalD3] = React.useState(false);
    const [modalPD3, setModalPD3] = React.useState(false);
        ...
        <div className={styles.newPage}>
            ...
            <div className={styles.nowPage}>
                <div className={styles.columnLeft}>
                    <div className={styles.columnLeftTitle}>
                        Выберите тип проекта
                    </div>
                    <div className={styles.newBtnList}>
                        <div className={styles.newBtnItem}>
                            <button
                            ...
                            <div className={styles.newBtnItemInfo}>
                                .jpg .jpeg .png .mp3
                            </div>
                        </div>
                        <div className={styles.newBtnItem}>
                            ...
                            >
                                ...
                                <span className={styles.tooltip}>
                                    <b>360</b>Панорамы 360/180 с поддержкой
                                    стерео и виртуальных туров
                                </span>
                            </button>
                            <div className={styles.newBtnItemInfo}>
                                .jpg .jpeg .png
                        ...
                        <div className={styles.newBtnItem}>
                            ...
                            >
                                ...
                                <span className={styles.tooltip}>
                                    <b>3D Модель</b>Просмотр 3D моделей в
                                    форматах экстерьер/интерьер
                                </span>
                            </button>
                            <div className={styles.newBtnItemInfo}>.fbx</div>
                        </div>
                        <div className={styles.newBtnItem}>
                            <button
                                className={styles.newBtn}
                                onClick={() => setModalPD3(true)}
                            >
                                Псевдо 3D
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                ...
                                <span className={styles.tooltip}>
                                    <b>Псевдо 3D</b>Фото объектов с вращением по
                                    одной или двум осям
                                </span>
                            </button>
                            <div className={styles.newBtnItemInfo}>
                ...
                <div className={styles.columnRight}>
                    <img src="/newproject.jpg" alt="arvizio" />
                </div>
            </div>
            <MyModal visible={modalGallery} setVisible={setModalGallery}>
                <GalleryPopup
                    setModal={(status) => {
                        setModalGallery(status);
                    }}
                />
            </MyModal>
            <MyModal visible={modalT} setVisible={setModalT}>
                <TPopup
                    setModal={
                        (status) => {
                            setModalT(status)
            ...
            <MyModal visible={modalD3} setVisible={setModalD3}>
                <D3Popup
                    setModal={(status) => {
                        setModalGallery(status);
                    }}
            ...
            <MyModal visible={modalPD3} setVisible={setModalPD3}>
                <PD3Popup
                    setModal={(status) => {
                        setModalPD3(status);
                    }}
